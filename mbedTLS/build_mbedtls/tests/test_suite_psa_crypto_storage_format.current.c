 ...
 *      Test suite file     : /home/kali/Desktop/dpki-protocol/MBED-TLS/MBED-TLS/mbedtls/tests/suites/test_suite_psa_crypto_storage_format.function
 *      Test suite data     : /home/kali/Desktop/dpki-protocol/MBED-TLS/MBED-TLS/build_mbedtls/tests/suites/test_suite_psa_crypto_storage_format.current.data
 *
 */
...
#line 2 "/home/kali/Desktop/dpki-protocol/MBED-TLS/MBED-TLS/mbedtls/tests/suites/test_suite_psa_crypto_storage_format.function"
...
#line 300 "/home/kali/Desktop/dpki-protocol/MBED-TLS/MBED-TLS/mbedtls/tests/suites/test_suite_psa_crypto_storage_format.function"
...
void test_key_storage_save_wrapper( void ** params )
{
    ...
    test_key_storage_save( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ), *( (int *) params[3] ), *( (int *) params[4] ), *( (int *) params[5] ), &data6, &data8 );
}
#line 345 "/home/kali/Desktop/dpki-protocol/MBED-TLS/MBED-TLS/mbedtls/tests/suites/test_suite_psa_crypto_storage_format.function"
...
void test_key_storage_read_wrapper( void ** params )
{
    ...
    test_key_storage_read( *( (int *) params[0] ), *( (int *) params[1] ), *( (int *) params[2] ), *( (int *) params[3] ), *( (int *) params[4] ), *( (int *) params[5] ), &data6, &data8, *( (int *) params[10] ) );
}
